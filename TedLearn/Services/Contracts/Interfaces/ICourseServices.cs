...
public interface ICourseServices
{
    ...
    Task<bool> IsCourseExistAsync(string courseTitle , CancellationToken cancellationToken = default);
    ...
    Task<ShowCourseDetailsDto> GetCourseForShowAsync(string courseTitle , CancellationToken cancellationToken = default);
    Task<bool> IsUserInCourseAsync(int userId, int courseId, CancellationToken cancellationToken = default);
    Task<int> GetCourseIdByCourseTitleAsync(string courseTitle , CancellationToken cancellationToken = default);
    Task<decimal> GetCoursePriceByIdAsync(int courseId, CancellationToken cancellationToken = default);
    Task<GetMyCoursesDto> GetUserCoursesAsync(int userId, int take = 10, int pageId = 1 , CancellationToken cancellationToken = default);
    ...
    Task AddUserCourseAsync(UserCourse userCourse, CancellationToken cancellationToken = default, bool withSaveChanges = true, bool configureAwait = false);
